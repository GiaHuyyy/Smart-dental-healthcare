...
const MOCK_TOKEN =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IlRlc3QgVXNlciIsImlhdCI6MTUxNjIzOTAyMiwicm9sZSI6ImFkbWluIn0.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c";
...
const apiEndpoints = [
  ...
  {
    method: "GET",
    url: "/appointments/doctor/68a45f205e91c64efc53005b",
    description: "Lấy danh sách lịch hẹn của bác sĩ",
    requiresAuth: true,
  },
  {
    method: "GET",
    url: "/appointments/patient/68a4294faee99e31432653fd",
    description: "Lấy danh sách lịch hẹn của bệnh nhân",
    requiresAuth: true,
  },
  ...
  {
    method: "GET",
    url: "/medical-records/doctor/65f2e7d4e52b8b9d1e8b4568",
    description: "Lấy danh sách hồ sơ bệnh án của bác sĩ",
    requiresAuth: true,
  },
  {
    method: "GET",
    url: "/medical-records/patient/65f2e7d4e52b8b9d1e8b4567",
    description: "Lấy danh sách hồ sơ bệnh án của bệnh nhân",
    requiresAuth: true,
  },
  ...
  {
    method: "GET",
    url: "/notifications/user/65f2e7d4e52b8b9d1e8b4567",
    description: "Lấy danh sách thông báo của người dùng",
    requiresAuth: true,
  },
  {
    method: "PATCH",
    url: "/notifications/65f2e7d4e52b8b9d1e8b4569/read",
    description: "Đánh dấu thông báo đã đọc",
    requiresAuth: true,
  },
  {
    method: "PATCH",
    url: "/notifications/user/65f2e7d4e52b8b9d1e8b4567/read-all",
  ...
  {
    method: "GET",
    url: "/payments/patient/65f2e7d4e52b8b9d1e8b4567",
    description: "Lấy danh sách thanh toán của bệnh nhân",
    requiresAuth: true,
  },
  {
    method: "GET",
    url: "/payments/doctor/65f2e7d4e52b8b9d1e8b4568",
    description: "Lấy danh sách thanh toán của bác sĩ",
    requiresAuth: true,
  },
  // Sử dụng ID từ kết quả tạo thanh toán mới thay vì ID cố định
  {
    method: "PATCH",
    url: "/payments/68a403d1a97df7ab4a85eb73",
    body: { _id: "68a403d1a97df7ab4a85eb73", status: "completed" },
  ...
  {
    method: "GET",
    url: "/reviews/doctor/65f2e7d4e52b8b9d1e8b4568",
    description: "Lấy danh sách đánh giá của bác sĩ",
    requiresAuth: true,
  },
  {
    method: "GET",
    url: "/reviews/patient/65f2e7d4e52b8b9d1e8b4567",
    description: "Lấy danh sách đánh giá của bệnh nhân",
    requiresAuth: true,
  },
  {
    method: "GET",
    url: "/reviews/doctor/65f2e7d4e52b8b9d1e8b4568/rating",
    description: "Lấy điểm đánh giá trung bình của bác sĩ",
    requiresAuth: true,
  },
  ...
  { method: "GET", url: "/reports", description: "Lấy danh sách báo cáo", requiresAuth: true },
  {
    method: "POST",
    url: "/reports",
    body: { userId: "65f2e7d4e52b8b9d1e8b4567", title: "Báo cáo lỗi", content: "Mô tả chi tiết về lỗi gặp phải" },
    description: "Tạo báo cáo mới",
    requiresAuth: true,
  },
  {
    method: "GET",
    url: "/reports/user/65f2e7d4e52b8b9d1e8b4567",
    description: "Lấy danh sách báo cáo của người dùng",
    requiresAuth: true,
  },
  {
    method: "GET",
    url: "/reports/assignee/65f2e7d4e52b8b9d1e8b4568",
    description: "Lấy danh sách báo cáo được giao cho người dùng",
    requiresAuth: true,
  },
  // Sử dụng ID báo cáo có thực trong hệ thống
  {
    method: "PATCH",
    url: "/reports/68a4017fa97df7ab4a85ea8f/assign/65f2e7d4e52b8b9d1e8b4568",
    description: "Giao báo cáo cho người dùng",
    requiresAuth: true,
  },
  {
    method: "PATCH",
    url: "/reports/68a4017fa97df7ab4a85ea8f/resolve",
    body: { resolution: "Đã xử lý lỗi thành công" },
    description: "Giải quyết báo cáo",
    requiresAuth: true,
  },
  ...
  // Realtime Chat APIs
  {
    ...
    body: { patientId: "68a4294faee99e31432653fd", doctorId: "68a45f205e91c64efc53005b" },
    description: "Tạo cuộc hội thoại mới",
    requiresAuth: false,
    saveConversationId: true,
  },
  {
    method: "GET",
    url: "/realtime-chat/conversations?userId=68a4294faee99e31432653fd&userRole=patient",
    description: "Lấy danh sách cuộc hội thoại của bệnh nhân",
    requiresAuth: false,
  },
  {
    method: "GET",
    url: "/realtime-chat/conversations?userId=68a45f205e91c64efc53005b&userRole=doctor",
    description: "Lấy danh sách cuộc hội thoại của bác sĩ",
    requiresAuth: false,
  },
  {
    method: "POST",
    url: "/realtime-chat/messages",
    body: {
      conversationId: "CONVERSATION_ID",
      senderId: "68a4294faee99e31432653fd",
      content: "Xin chào bác sĩ, tôi cần tư vấn về tình trạng răng của tôi",
      type: "text",
    },
  ...
  {
    method: "GET",
    url: "/realtime-chat/conversations/CONVERSATION_ID/messages?userId=68a4294faee99e31432653fd&userRole=patient",
    description: "Lấy tin nhắn trong cuộc hội thoại",
    requiresAuth: false,
  },
];
