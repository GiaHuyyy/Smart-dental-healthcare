...
export default function DoctorPatients() {
  ...
  const fetchPatientAppointments = async (patientId: string) => {
    try {
      // Fetch more appointments to find completed ones (increased from 5 to 50)
      const response = await fetch(`/api/appointments/patient/${patientId}/history?current=1&pageSize=50`);
      const data = await response.json();
      ...
      if (data.success) {
        ...
        console.log(
          ...
          appointments.map((a: any) => a.status)
        );
          ...
          <div className="max-w-7xl mx-auto space-y-4">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-xl font-semibold text-gray-900">Quản lý bệnh nhân</h1>
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {patients.map((patient) => (
                          ...
                          >
                            ...
                            <td className="px-4 py-4">
                              <div className="text-sm text-gray-900 font-medium">{formatDate(patient.createdAt)}</div>
                            </td>
                            <td className="px-4 py-4">
                              <button
            ...
            {isModalOpen && selectedPatient && (
              <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-2 z-50" onClick={closeModal}>
                <div
                  className="bg-white rounded-lg max-w-6xl w-full max-h-[95vh] overflow-hidden shadow-xl border border-gray-200"
                  ...
                  <div className="px-5 py-4 border-b border-gray-200">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button onClick={closeModal} className="p-2 hover:bg-gray-100 rounded-md" aria-label="Đóng">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  ...
                                  <div className="space-y-1">
                                    ...
                                    <p className="text-gray-900 font-medium text-sm">
                                      {selectedPatient.dateOfBirth
                                        ? `${formatDate(selectedPatient.dateOfBirth)} (${calculateAge(
                                            selectedPatient.dateOfBirth
                                          )} tuổi)`
                                        : "Chưa cập nhật"}
                                    </p>
                                  ...
                                  <div className="space-y-1">
                                    ...
                                    <div className="mt-1">{getStatusBadge(selectedPatient.isActive)}</div>
                                  </div>
                                    ...
                                    <div className="flex items-center justify-between py-1.5">
                                      ...
                                      <span className="text-sm font-bold text-gray-900">
                                        {paymentStats.totalPaid > 0
                                          ? paymentStats.totalPaid.toLocaleString("vi-VN") + " VNĐ"
                                          : "0 VNĐ"}
                                      </span>
                                    </div>
                                    <div className="flex items-center justify-between py-1.5">
                                      <span className="text-sm text-gray-600 font-medium">Lượt thanh toán</span>
                                      <span className="text-sm font-bold text-gray-900">{paymentStats.paid} lượt</span>
                                    </div>
                              ...
                              {patientAppointments.length > 0 ? (
                                ...
                                <div className="text-center py-12">
                                  ...
                                  <p className="text-gray-500 text-sm mb-4">
                                    Bệnh nhân này chưa có lịch hẹn nào trong hệ thống
                                  </p>
                                  <button
                                    onClick={() => {
                                      closeModal();
                              ...
                              {patientMedicalRecords.length > 0 ? (
                                    ...
                                    <div className="flex justify-between items-start mb-3">
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                          ...
                                          <p className="text-gray-600 text-xs">
                                            Bác sĩ: {record.doctorId?.fullName || "N/A"} (
                                ...
                                <div className="text-center py-8">
                                  ...
                                  <p className="text-gray-500 text-xs mb-4">
                                    Bệnh nhân này chưa có hồ sơ bệnh án nào được tạo.
                                  </p>
                                  <button
                                    onClick={() => {
                                      closeModal();
            ...
            {isPrescriptionModalOpen && selectedPrescription && selectedPatient && (
              ...
              >
                <div
                  className="print-prescription bg-white rounded-lg max-w-4xl w-full max-h-[95vh] overflow-hidden shadow-xl border border-gray-200"
                  onClick={(e) => e.stopPropagation()}
                >
                  {/* Modal Header */}
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">
                            Bệnh nhân: {selectedPatient.fullName} • Ngày kê:{" "}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-gray-50 rounded-lg p-4">
                          ...
                          <div className="space-y-2 text-sm">
                            <div>
                              <span className="font-medium">Họ tên:</span> {selectedPatient.fullName}
                            </div>
                            <div>
                              <span className="font-medium">Tuổi:</span>{" "}
                              {selectedPatient.dateOfBirth ? calculateAge(selectedPatient.dateOfBirth) : "N/A"} tuổi
                            </div>
                            <div>
                            ...
                            <div>
                              <span className="font-medium">SĐT:</span> {selectedPatient.phone}
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-gray-50 rounded-lg p-4">
                          ...
                          <div className="space-y-2 text-sm">
                            <div>
                              <span className="font-medium">Bác sĩ:</span> {selectedPrescription.doctorId.fullName}
                            </div>
                            <div>
                              <span className="font-medium">Chuyên khoa:</span>{" "}
                              {selectedPrescription.doctorId.specialty}
                            </div>
                            <div>
                          ...
                          {selectedPrescription.totalCost && (
                            <div className="bg-purple-50 rounded-lg p-4">
                              ...
                              <p className="text-gray-700 text-sm font-medium">
                                {selectedPrescription.totalCost.toLocaleString("vi-VN")} VNĐ
                              </p>
                            </div>
                          )}
                        </div>
