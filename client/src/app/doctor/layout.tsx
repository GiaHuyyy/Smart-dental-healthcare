...
import { BarChart2, Calendar, MessageSquare, Settings, Stethoscope, User, Users, Wallet } from "lucide-react";
...
const navigation = [
  ...
  { name: "Về tôi", href: "/doctor/about", icon: <User className="w-4 h-4" /> },
