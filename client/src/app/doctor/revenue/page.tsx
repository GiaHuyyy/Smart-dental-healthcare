  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-6">
        ...
        {/* Summary Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 pt-6 pb-6">
          ...
          <button
            ...
            className={`bg-white rounded-xl ring-2  ${
              statusFilter === "refund" ? " ring-red-500" : "ring-transparent "
            }`}
          >
            <Card className="text-left h-full">
              <CardContent className="pt-6">
                      ...
                      <div className="grid grid-cols-12 gap-4 items-center">
                        ...
                        <div className="col-span-2 flex items-center">
                          <p className="text-[15px] text-gray-900">
                            {revenue.status === "completed" && revenue.revenueDate
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span
                      className={`font-semibold ${
                        (selectedRevenue.amount || 0) >= 0 ? "text-gray-900" : "text-red-600"
                      }`}
                    >
