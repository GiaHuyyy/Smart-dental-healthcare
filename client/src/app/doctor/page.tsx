        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="kpi-card group hover:scale-105 transition-transform duration-200">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: "var(--color-primary-50)" }}>
          ...
          <div className="kpi-card group hover:scale-105 transition-transform duration-200">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: "var(--color-success-light)" }}>
          ...
          {/* Waiting Patients */}
          <div className="kpi-card group hover:scale-105 transition-transform duration-200" style={{ borderLeft: "1px solid var(--color-warning)" }}>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: "var(--color-warning-light)" }}>
            ...
            <div className="flex items-end justify-between">
              <div className="text-3xl font-bold" style={{ color: "var(--color-warning)" }}>3</div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="healthcare-card-elevated">
              ...
              <div className="p-6 space-y-4">
                {/* Appointment Item */}
                <div className="healthcare-card p-4 hover:shadow-md transition-shadow cursor-pointer" style={{ borderLeft: "1px solid var(--color-primary)" }}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: "var(--color-primary-50)" }}>
                ...
                <div className="healthcare-card p-4 hover:shadow-md transition-shadow cursor-pointer" style={{ borderLeft: "1px solid var(--color-success)" }}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: "var(--color-success-light)" }}>
                        <UserCheck className="w-6 h-6" style={{ color: "var(--color-success)" }} />
                      </div>
                      <div>
                ...
                <div className="healthcare-card p-4 hover:shadow-md transition-shadow cursor-pointer" style={{ borderLeft: "1px solid var(--color-warning)" }}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: "var(--color-warning-light)" }}>
                        <Timer className="w-6 h-6" style={{ color: "var(--color-warning)" }} />
                      </div>
                      <div>
            ...
            <div className="healthcare-card-elevated">
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-start gap-4">
                  <div className="w-3 h-3 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: "var(--color-success)" }}></div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-3 h-3 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: "var(--color-primary)" }}></div>
                  <div className="flex-1">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-3 h-3 rounded-full mt-2 flex-shrink-0" style={{ backgroundColor: "var(--color-warning)" }}></div>
                  <div className="flex-1">
              ...
              <div className="p-6 space-y-4">
                <div className="healthcare-card p-3" style={{ borderLeft: "1px solid var(--color-danger)" }}>
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "var(--color-danger-light)" }}>
                ...
                <div className="healthcare-card p-3">
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "var(--color-primary-50)" }}>
            ...
            <div className="healthcare-card-elevated">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold" style={{ color: "var(--color-success)" }}>97%</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600">Thời gian chờ TB</span>
                  <span className="font-semibold" style={{ color: "var(--color-primary)" }}>8 phút</span>
                </div>
              </div>
            </div>
          </div>
