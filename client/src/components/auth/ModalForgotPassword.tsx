          ...
          <>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-center text-lg tracking-widest focus:outline-none focus:ring-2 focus:border-transparent"
            ...
            <div className="flex space-x-3">
              ...
              <button
                ...
                className="flex-1 btn-primary-filled disabled:opacity-50 text-white font-medium py-2.5 px-4 rounded-lg transition-colors focus:outline-none"
              >
                {isLoading ? (
                  <span className="flex items-center justify-center">
                    <Loader2 className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" />
