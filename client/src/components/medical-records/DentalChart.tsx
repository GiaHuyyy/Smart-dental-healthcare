    ...
    <div className="space-y-6">
      ...
      <Card className="overflow-hidden">
        <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b">
          ...
          <p className="text-center text-sm text-gray-600">Hiển thị tình trạng răng từ tất cả hồ sơ điều trị</p>
        </CardHeader>
        <CardContent className="p-8">
          {/* Upper Teeth Arc */}
          <div className="mb-12 relative">
            <h4 className="text-center text-sm font-semibold text-gray-700 mb-6">Hàm trên (Răng 1-16)</h4>
            <div className="relative w-full h-48 flex justify-center items-center">
              {/* Arc line for visual reference */}
              <svg className="absolute inset-0 w-full h-full" style={{ pointerEvents: "none" }}>
                <path d="M 80 80 Q 200 20 320 80" stroke="#e5e7eb" strokeWidth="2" fill="none" strokeDasharray="5,5" />
              </svg>
              ...
              ${tooth.hasData ? "ring-2 ring-offset-1 ring-blue-200" : ""}
                  ...
                  title={`Răng ${tooth.number}: ${getConditionLabel(tooth.condition)}${
          ...
          <div className="relative">
            <h4 className="text-center text-sm font-semibold text-gray-700 mb-6">Hàm dưới (Răng 17-32)</h4>
            <div className="relative w-full h-48 flex justify-center items-center">
              {/* Arc line for visual reference */}
              <svg className="absolute inset-0 w-full h-full" style={{ pointerEvents: "none" }}>
                <path
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white border-0">
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold">{Array.from(allTeeth.values()).filter((t) => t.treatment).length}</div>
